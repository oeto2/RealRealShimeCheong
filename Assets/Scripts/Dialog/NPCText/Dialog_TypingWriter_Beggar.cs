...
public class Dialog_TypingWriter_Beggar : Dialogue,ITalkable
{
      public IEnumerator TextPractice()
    {
        ...
        else if (ObjectManager.instance.GetEquipObjectKey() == 1005)
        {
            ...
            //주먹밥 먹는 중..
            yield return StartCoroutine(DialogManager.instance.ItemClueChat(dialogdb.NPC_01[869].npc_name, dialogdb.NPC_01[869].comment, true));
